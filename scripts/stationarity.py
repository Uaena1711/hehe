...
# Run ADF test on the 'DEMAND' column
# Ensure df_time_series['DEMAND'] has no NaN values before passing to adfuller if imputation was done
...
print("\nInterpretation:")
if p_value <= 0.05:
    print("Reject the null hypothesis (H0). The series is likely stationary.")
else:
    print("Fail to reject the null hypothesis (H0). The series is likely non-stationary.")
print("-" * 25)
